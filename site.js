...
(function () {
  ...
  var translations = {
    de: {
      ...
      g2_f5: 'Neuer Artstyle aus Gothic-Sequel- und Gothic-II-Alpha-Elementen – ermöglicht durch unzählige neue und eigens erstellte Assets',
      ...
      g2_g6: 'Erweiterte und neue Handwerke – bekannt aus dem Gothic Sequel',
    ...
    en: {
      ...
      g2_f5: 'A new art style built from Gothic Sequel and Gothic II alpha elements – enabled by countless new and custom-made assets',
      ...
      g2_g6: 'Expanded and brand-new crafts – known from the Gothic Sequel',
    ...
    pl: {
      ...
      g2_f5: 'Nowy styl graficzny zbudowany z elementów Gothic Sequel i alfy Gothica II – dzięki niezliczonym nowym i autorskim assetom',
      ...
      g2_g6: 'Rozszerzone i zupełnie nowe rzemiosła – znane z Gothic Sequel',
    ...
    ru: {
      ...
      g2_overview: 'Anniversary Edition — масштабное фанатское расширение для Gothic II: Ночь Ворона. Оно расширяет и частично перерабатывает основной сюжет, а также старые и новые побочные задания, добавляет новые гильдии и пути, увеличивает мир новыми областями и жителями — и придаёт игре собственный визуальный стиль, основанный на Gothic Sequel и альфа-материалах Gothic II. После релиза выйдут обновления, которые продолжат расширять историю и перерабатывать меши мира.',
      ...
      g2_f5: 'Новый арт-стиль из элементов Gothic Sequel и альфы Gothic II — благодаря бесчисленным новым и авторским ресурсам',
      ...
      g2_g6: 'Расширенные и совершенно новые ремёсла — известные по Gothic Sequel',
