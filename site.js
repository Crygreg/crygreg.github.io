...
(function () {
  ...
  var translations = {
    de: {
      ...
      role_lead: 'Projektleitung',
      role_model: 'Modeller',
      role_script: 'Scripter',
      team_name: 'Name hier eintragen',
    ...
    pl: {
      ...
      role_lead: 'Kierownictwo projektu',
      role_model: 'Modelarz',
      role_script: 'Skrypter',
      team_name: 'Nazwa do uzupełnienia',
    ...
    ru: {
      ...
      role_lead: 'Руководство проектом',
      role_model: 'Моделлер',
      role_script: 'Скриптер',
      team_name: 'Имя будет добавлено',
