...
(function () {
  ...
  var translations = {
    de: {
      ...
      download_h: 'Download',
      download_note: 'Die Anniversary Edition befindet sich noch in Entwicklung – der Download erscheint im Laufe des Jahres 2026.',
      download_btn: 'DOWNLOAD',
      download_soon: 'Der Download ist noch nicht verfügbar – Release irgendwann 2026.',
    ...
    en: {
      ...
      screenshot: 'Screenshot',
      download_h: 'Download',
      download_note: 'The Anniversary Edition is still in development – the download will release sometime in 2026.',
      download_btn: 'DOWNLOAD',
      download_soon: 'The download is not available yet – releasing sometime in 2026.',
    ...
    pl: {
      ...
      download_note: 'Edycja Rocznicowa jest wciąż w fazie rozwoju – link do pobrania pojawi się w 2026 roku.',
      download_btn: 'POBIERZ',
      download_soon: 'Pobieranie nie jest jeszcze dostępne – premiera w 2026 roku.',
    ...
    ru: {
      ...
      download_note: 'Юбилейное издание всё ещё в разработке – ссылка на скачивание появится в течение 2026 года.',
      download_btn: 'СКАЧАТЬ',
      download_soon: 'Скачивание пока недоступно – релиз в 2026 году.',
