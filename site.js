...
(function () {
  ...
  var translations = {
    de: {
      ...
      role_alistair: '2D/3D & Animation · Scripting (Daedalus) · Coding (C++/Union) · QA & Feedback',
    ...
    pl: {
      ...
      role_alistair: 'Grafika 2D/3D i animacja · Skrypty (Daedalus) · Kod (C++/Union) · QA i feedback',
    ...
    ru: {
      ...
      role_alistair: '2D/3D и анимация · Скрипты (Daedalus) · Код (C++/Union) · QA и обратная связь',
