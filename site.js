...
(function () {
  ...
  var translations = {
    de: {
      ...
      support_note: 'Dies sind die persönlichen Seiten von Crygreg – freiwillige Wege, die Entwicklung zu unterstützen; das Projekt bleibt nichtkommerziell. Andere Mitglieder können später eigene Seiten hinzufügen.',
    ...
    en: {
      ...
      support_h: 'Support',
      support_note: 'These are the personal pages of Crygreg – voluntary ways to support development; the project stays non-commercial. Other members may add their own pages later.',
      screenshot: 'Screenshot',
      download_h: 'Download',
    ...
    pl: {
      ...
      support_h: 'Wesprzyj',
      support_note: 'To osobiste strony Crygrega – dobrowolne sposoby wsparcia rozwoju; projekt pozostaje niekomercyjny. Inni członkowie mogą później dodać własne strony.',
    ...
    ru: {
      ...
      support_h: 'Поддержка',
      support_note: 'Это личные страницы Crygreg — добровольные способы поддержать разработку; проект остаётся некоммерческим. Другие участники могут позже добавить свои страницы.',
      screenshot: 'Скриншот',
