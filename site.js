...
(function () {
  ...
  var translations = {
    de: {
      ...
      g2_overview: 'Die Anniversary Edition ist eine umfangreiche Fan-Erweiterung für Gothic II: Die Nacht des Raben. Sie erweitert und überarbeitet die Hauptgeschichte ebenso wie alte und neue Nebenhandlungen, führt neue Gilden und Wege ein, vergrößert die Welt um neue Areale und Bewohner – und verpasst dem Spiel einen eigenen Artstyle, der auf der Fortsetzung von Gothic I sowie Alpha-Material von Sequel und Gothic II aufbaut. Auch nach der Veröffentlichung sind weitere Updates geplant, die die Geschichte ausbauen und die Welt-Meshes weiter überarbeiten.',
      g2_cat_main: 'Hauptfeatures',
      g2_cat_game: 'Gameplay',
      g2_cat_content: 'Inhalt',
      g2_cat_gfx: 'Grafik',
      g2_f1: 'Erweiterte und teilweise sanft überarbeitete Hauptgeschichte (4 neue Quests) – plus rund 50 neue Nebenquests, viele davon an die Fraktionswahl gebunden',
      g2_f2: 'Mehrere alternative Wege und Lösungen in zahlreichen Originalquests',
      g2_f3: 'Gildenloser Pfad sowie drei neue Untergilden: Wassermagier, Dämonenjäger und Königliche Garde',
      g2_f4: 'Logisch erweiterte Weltlevels – bevölkert von unzähligen neuen NPCs',
      g2_f5: 'Neuer Artstyle aus G1-Fortsetzungs-, Sequel- und G2-Alpha-Elementen – ermöglicht durch unzählige neue und eigens erstellte Assets',
      g2_f6: 'Weitere Updates nach dem Release, die die Geschichte erweitern und die Welt-Meshes weiter überarbeiten',
      g2_g1: 'Vier wählbare Schwierigkeitsgrade – keine Bullet-Sponges, dafür tiefere Änderungen am Spielerlebnis',
      g2_g2: 'Neue Schadensberechnung: eine Mischung aus Gothic I und Gothic II – plus ein paar geheime Zutaten',
      ...
      g2_g4: 'KI-Überarbeitungen: NPCs reagieren auf den Status des Helden (und anderer), können Verbrechen ignorieren oder fliehen; Opfer und Zeugen kommentieren bezahlte Strafen und grüßen je nach Status und Freundschaft',
      g2_g5: 'Ausdauer und Sprinten (mit kaum Auswirkungen aufs Kampfsystem) sowie Stab- und Schildkampf',
      g2_g6: 'Erweiterte und neue Handwerke – bekannt aus der Fortsetzung',
      g2_g7: 'Neu geordnetes Statusmenü mit Seitenwechsel; LP-Verbrauch wird statt Charakterwerten festgehalten',
      g2_g8: 'Viele neue Waffen – darunter aus Gothic I bekannte – und neue Rüstungen, gildenlos wie für Gilden, inklusive ergänzter fehlender Ränge',
      g2_g9: 'Todesmeldungen (kapitelabhängig und -unabhängig) sowie wirklich versteckte Orte – EXP fürs Finden, keine gewöhnlichen Verstecke',
      g2_g10: 'Unzählige Bugfixes und kosmetische Verbesserungen – im Ernst',
      g2_c1: 'Fraktionsentscheidungen bringen viele neue Möglichkeiten und Konsequenzen mit sich',
      g2_c2: 'Zahlreiche Überarbeitungen bestehender Dialoge, Interaktionen und NPC-Routinen',
      g2_x1: 'Neue, überarbeitete Benutzeroberfläche',
      g2_x2: 'Unzählige Modell-Überarbeitungen, -Variationen und -Korrekturen (UV-Mapping, Verzerrungen, fehlende Vertices)',
    ...
    en: {
      ...
      g2_overview: 'The Anniversary Edition is an extensive fan expansion for Gothic II: Night of the Raven. It expands and gently reworks the main story as well as old and new side quests, introduces new guilds and paths to take, enlarges the world with new areas and inhabitants – and gives the game its own art style built on the Gothic I sequel and on Sequel and Gothic II alpha material. Further updates after release will keep expanding the story and reworking the world meshes.',
      g2_cat_main: 'Key features',
      g2_cat_game: 'Gameplay',
      g2_cat_content: 'Content',
      g2_cat_gfx: 'Graphics',
      g2_f1: 'Expanded and partially reworked main story (4 new quests) – plus around 50 new side quests, many of them tied to your faction choice',
      g2_f2: 'Multiple alternative ways to approach and solve numerous original quests',
      g2_f3: 'A guildless path plus three new sub-guilds: Water Mages, Demon Hunters and the Royal Guard',
      g2_f4: 'Logically extended world levels – populated by countless new NPCs',
      g2_f5: 'A new art style built from Gothic I sequel, Sequel and Gothic II alpha elements – enabled by countless new and custom-made assets',
      g2_f6: 'Further updates after release that expand the story and keep reworking the world meshes',
      g2_g1: 'Four selectable difficulty levels – no bullet sponges, but deeper changes to the experience',
      g2_g2: 'New damage calculation – a mix of Gothic I and II, plus a few secret ingredients',
      g2_g3: 'Reworked boss fights and a new balance – in places deeper or harder than the original, elsewhere a little easier',
      g2_g4: 'AI overhauls: NPCs react to the hero’s status (and others’), can ignore crimes or flee; victims and witnesses comment on paid fines and greet you according to status and friendship',
      g2_g5: 'Stamina and sprinting (with little to no impact on combat) plus staff and shield fighting',
      g2_g6: 'Expanded and brand-new crafts – known from the sequel',
      g2_g7: 'Reordered status menu with page switching; LP costs are recorded instead of character stats',
      g2_g8: 'Many new weapons – including ones known from Gothic I – and new armors, guildless and for guilds, with missing ranks filled in',
      g2_g9: 'Death messages (chapter-dependent and independent) and genuinely hidden places – EXP for finding them; these are truly hidden, not ordinary stashes',
      g2_g10: 'Countless bug fixes and cosmetic improvements – seriously',
      g2_c1: 'Faction choices come with many new possibilities and consequences',
      g2_c2: 'Numerous reworks of existing dialogues, interactions and NPC routines',
      g2_x1: 'A new, reworked user interface',
      g2_x2: 'Countless model revisions, variations and fixes (UV mapping, distortions, missing vertices)',
    ...
    pl: {
      ...
      g2_overview: 'Anniversary Edition to rozbudowane fanowskie rozszerzenie do Gothic II: Noc Kruka. Rozszerza i częściowo przerabia fabułę główną oraz stare i nowe zadania poboczne, wprowadza nowe gildie i ścieżki, powiększa świat o nowe obszary i mieszkańców – i nadaje grze własny styl graficzny oparty na sequelu Gothica I oraz materiałach alfa Sequel i Gothica II. Po premierze planowane są kolejne aktualizacje, które rozbudują historię i dalej przerobią meshe świata.',
      g2_cat_main: 'Główne cechy',
      g2_cat_game: 'Rozgrywka',
      g2_cat_content: 'Treść',
      g2_cat_gfx: 'Grafika',
      g2_f1: 'Rozbudowana i częściowo delikatnie przerobiona fabuła główna (4 nowe zadania) – plus około 50 nowych zadań pobocznych, w większości powiązanych z wyborem frakcji',
      g2_f2: 'Wiele alternatywnych dróg i rozwiązań w licznych oryginalnych zadaniach',
      g2_f3: 'Ścieżka bez gildii oraz trzy nowe podgildie: Magowie Wody, Łowcy Demonów i Gwardia Królewska',
      g2_f4: 'Logicznie rozszerzone poziomy świata – zamieszkane przez niezliczonych nowych NPC-ów',
      g2_f5: 'Nowy styl graficzny zbudowany z elementów sequela Gothica I, Sequel i alfy Gothica II – dzięki niezliczonym nowym i autorskim assetom',
      g2_f6: 'Kolejne aktualizacje po premierze rozbudują historię i dalej przerobią meshe świata',
      g2_g1: 'Cztery poziomy trudności do wyboru – żadnych „gąbek na pociski”, za to głębsze zmiany w rozgrywce',
      g2_g2: 'Nowa kalkulacja obrażeń – mieszanka Gothica I i II z kilkoma sekretnymi składnikami',
      ...
      g2_g6: 'Rozszerzone i zupełnie nowe rzemiosła – znane z sequela',
      g2_g7: 'Przegrupowane menu statusu z przerzucaniem stron; zużycie PN zapisywane zamiast statystyk postaci',
      g2_g8: 'Wiele nowych broni – w tym znanych z Gothica I – oraz nowe pancerze, bez gildii i dla gildii, z uzupełnionymi brakującymi rangami',
      g2_g9: 'Komunikaty o śmierci (zależne i niezależne od rozdziału) oraz naprawdę ukryte miejsca – PD za ich odnalezienie; to nie są zwykłe skrytki',
      g2_g10: 'Niezliczone poprawki błędów i usprawnienia kosmetyczne – naprawdę',
      g2_c1: 'Wybory frakcji niosą ze sobą wiele nowych możliwości i konsekwencji',
      g2_c2: 'Liczne przeróbki istniejących dialogów, interakcji i rutyn NPC-ów',
      g2_x1: 'Nowy, przerobiony interfejs użytkownika',
      g2_x2: 'Niezliczone przeróbki, warianty i poprawki modeli (mapowanie UV, zniekształcenia, brakujące wierzchołki)',
    ...
    ru: {
      ...
      g2_overview: 'Anniversary Edition — масштабное фанатское расширение для Gothic II: Ночь Ворона. Оно расширяет и частично перерабатывает основной сюжет, а также старые и новые побочные задания, добавляет новые гильдии и пути, увеличивает мир новыми областями и жителями — и придаёт игре собственный визуальный стиль, основанный на продолжении Gothic I и альфа-материалах Sequel и Gothic II. После релиза выйдут обновления, которые продолжат расширять историю и перерабатывать меши мира.',
      g2_cat_main: 'Ключевые особенности',
      g2_cat_game: 'Геймплей',
      g2_cat_content: 'Контент',
      g2_cat_gfx: 'Графика',
      g2_f1: 'Расширенная и частично мягко переработанная основная история (4 новых квеста) — плюс около 50 новых побочных заданий, многие из которых зависят от выбора фракции',
      g2_f2: 'Несколько альтернативных путей и решений во множестве оригинальных квестов',
      g2_f3: 'Путь без гильдии и три новых субгильдии: Маги Воды, Охотники на демонов и Королевская гвардия',
      g2_f4: 'Логично расширенные уровни мира — населённые бесчисленными новыми NPC',
      g2_f5: 'Новый арт-стиль из элементов продолжения Gothic I, Sequel и альфы Gothic II — благодаря бесчисленным новым и авторским ресурсам',
      g2_f6: 'После релиза выйдут обновления, которые расширят историю и продолжат перерабатывать меши мира',
      g2_g1: 'Четыре уровня сложности на выбор — никаких «губок для урона», зато более глубокие изменения в игровом процессе',
      g2_g2: 'Новый расчёт урона — смесь Gothic I и II с парой секретных ингредиентов',
      ...
      g2_g6: 'Расширенные и совершенно новые ремёсла — известные по продолжению',
      g2_g7: 'Перекомпонованное меню статуса с перелистыванием страниц; расход ОО фиксируется вместо характеристик',
      g2_g8: 'Множество новых видов оружия — в том числе знакомых по Gothic I — и новые доспехи, без гильдии и для гильдий, с дополненными недостающими рангами',
      g2_g9: 'Сообщения о смертях (зависящие и не зависящие от главы) и по-настоящему скрытые места — опыт за их нахождение; это не обычные тайники',
      g2_g10: 'Бесчисленные исправления ошибок и косметические улучшения — всерьёз',
      g2_c1: 'Выбор фракции открывает множество новых возможностей и последствий',
      g2_c2: 'Многочисленные переработки существующих диалогов, взаимодействий и распорядков NPC',
      g2_x1: 'Новый переработанный интерфейс',
      g2_x2: 'Бесчисленные переработки, вариации и исправления моделей (UV-развёртки, искажения, недостающие вершины)',
