...
(function () {
  ...
  var translations = {
    de: {
      ...
      g2_v1: 'Neuer Artstyle aus Gothic-I-, Gothic-Sequel- und Gothic-II-Alpha-Elementen – ermöglicht durch unzählige neue und eigens erstellte Assets',
    ...
    en: {
      ...
      g2_v1: 'A new art style built from Gothic I, Gothic Sequel and Gothic II alpha elements – enabled by countless new and custom-made assets',
    ...
    pl: {
      ...
      g2_v1: 'Nowy styl graficzny zbudowany z elementów Gothica I, Gothic Sequel i alfy Gothica II – dzięki niezliczonym nowym i autorskim zasobom',
    ...
    ru: {
      ...
      g2_overview: 'Anniversary Edition — масштабное фанатское расширение для Gothic II: Ночь Ворона. Оно расширяет и частично перерабатывает основной сюжет, а также старые и новые побочные задания, добавляет новые гильдии и пути, увеличивает мир новыми областями и жителями — и придаёт игре собственный визуальный стиль, основанный на Gothic I, Gothic Sequel и альфа-материалах Gothic II. После релиза выйдут обновления, которые продолжат расширять историю и перерабатывать меши мира.',
      ...
      g2_v1: 'Новый арт-стиль из элементов Gothic I, Gothic Sequel и альфы Gothic II — благодаря бесчисленным новым и авторским ресурсам',
