...
(function () {
  ...
  var translations = {
    de: {
      ...
      g2_s5: 'Logisch erweiterte Weltlevels – bevölkert von unzähligen neuen NPCs',
      g2_s6: 'Überarbeitete Dialoge, Interaktionen und NPC-Routinen für eine reaktivere Welt',
      g2_s7: 'Wirklich versteckte Orte – EXP fürs Finden; keine gewöhnlichen Verstecke',
      ...
      g2_e1: 'Neu geordnetes Statusmenü mit Seitenwechsel; LP-Kosten beim Lernen steigen mit dem bereits Trainierten – unabhängig von den Charakterwerten',
      g2_e2: 'Erweiterte und neue Handwerke – bekannt aus dem Gothic Sequel',
      g2_e3: 'Viele neue Waffen – darunter aus Gothic I bekannte',
      g2_e4: 'Neue Rüstungen, gildenlos wie für Gilden – fehlende Ränge ergänzt, bestehende Progression erweitert',
      g2_v1: 'Neuer Artstyle aus Gothic-Sequel- und Gothic-II-Alpha-Elementen – ermöglicht durch unzählige neue und eigens erstellte Assets',
    ...
    en: {
      ...
      g2_s7: 'Genuinely hidden places – EXP for finding them; not ordinary stashes',
      ...
      g2_e1: 'Reordered status menu with page switching; LP costs scale with how much you have already trained – independent of your character stats',
      g2_e2: 'Expanded and brand-new crafts – known from the Gothic Sequel',
      g2_e3: 'Many new weapons – including ones known from Gothic I',
      g2_e4: 'New armors, guildless and for guilds – missing ranks filled in, existing progression expanded',
      g2_v1: 'A new art style built from Gothic Sequel and Gothic II alpha elements – enabled by countless new and custom-made assets',
    ...
    pl: {
      ...
      g2_s7: 'Naprawdę ukryte miejsca – PD za ich odnalezienie; to nie są zwykłe skrytki',
      ...
      g2_e1: 'Przegrupowane menu statusu z przerzucaniem stron; koszt nauki w PN rośnie wraz z dotychczas wytrenowanym – niezależnie od statystyk postaci',
      g2_e2: 'Rozszerzone i zupełnie nowe rzemiosła – znane z Gothic Sequel',
      g2_e3: 'Wiele nowych broni – w tym znanych z Gothica I',
      g2_e4: 'Nowe pancerze, bez gildii i dla gildii – uzupełnione brakujące rangi, rozbudowana progresja',
      g2_v1: 'Nowy styl graficzny zbudowany z elementów Gothic Sequel i alfy Gothica II – dzięki niezliczonym nowym i autorskim assetom',
    ...
    ru: {
      ...
      g2_s7: 'По-настоящему скрытые места — опыт за их нахождение; это не обычные тайники',
      ...
      g2_e1: 'Перекомпонованное меню статуса с перелистыванием страниц; стоимость обучения в ОО растёт в зависимости от уже изученного, а не от характеристик',
      g2_e2: 'Расширенные и совершенно новые ремёсла — известные по Gothic Sequel',
      g2_e3: 'Множество новых видов оружия — в том числе знакомых по Gothic I',
      g2_e4: 'Новые доспехи, без гильдии и для гильдий — дополнены недостающие ранги, расширена прогрессия',
      g2_v1: 'Новый арт-стиль из элементов Gothic Sequel и альфы Gothic II — благодаря бесчисленным новым и авторским ресурсам',
