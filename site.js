...
(function () {
  ...
  var translations = {
    de: {
      ...
      cr_thanks_1: 'An den Rest des Kernteams, der trotz etwaiger Meinungsverschiedenheiten und langen Diskussionen über längere Zeit am Ball blieb, denn ohne euch wäre die Mod heute nur zu 1/4 so groß und gut geworden.',
      cr_thanks_2: 'All jene aus der Gothic Modding Community, die ihre Assets und Ressourcen geteilt haben, um sie nutzen zu dürfen.',
      cr_thanks_3: 'Die <a href="https://discord.gg/P3kZcnfXzZ" target="_blank" rel="noopener noreferrer">Gothic Modding Community</a> (Discord Server, von Cipher betrieben, der damals mit der fantastischen Idee dieses Server zu mir und anderen kam!) &amp; auch World of Gothic (und damit auch Danke an DonEsteban!) für die grandiose Hilfe im Laufe dieser Jahre. Ohne alle Beteiligten wäre das hier nie möglich gewesen.',
      cr_thanks_4: 'Die Synchronsprecher aus dem Original, die teils einer KI Nutzung zugestimmt haben oder sogar / alternativ einwilligten, einzusprechen. Die gesamte Community hat eure Arbeit geliebt und feiert sie auch nun mehr als 25 Jahre später. Vielen, vielen Dank.',
    ...
    en: {
      ...
      cr_thanks_1: 'To the rest of the core team, who stuck with it despite disagreements and long discussions over a long time – because without you, the mod would only be a quarter as big and as good today.',
      cr_thanks_2: 'Everyone in the Gothic modding community who shared their assets and resources for others to use.',
      cr_thanks_3: 'The <a href="https://discord.gg/P3kZcnfXzZ" target="_blank" rel="noopener noreferrer">Gothic Modding Community</a> (Discord server run by Cipher, who back then came to me and others with the fantastic idea for this server!) &amp; also World of Gothic (and with that, thanks to DonEsteban!) for the amazing help over these years. Without everyone involved, none of this would have been possible.',
      cr_thanks_4: 'The voice actors from the original, some of whom agreed to AI usage or even / alternatively consented to re-record their lines. The entire community loved your work and still celebrates it more than 25 years later. Thank you so, so much.',
      screenshot: 'Screenshot',
      download_h: 'Download',
    ...
    pl: {
      ...
      cr_thanks_1: 'Reszcie głównego zespołu, który mimo różnic zdań i długich dyskusji wytrwał przez długi czas – bo bez was mod byłby dziś tylko w 1/4 tak duży i dobry.',
      ...
      cr_thanks_3: 'Społeczności <a href="https://discord.gg/P3kZcnfXzZ" target="_blank" rel="noopener noreferrer">Gothic Modding Community</a> (serwer Discord prowadzony przez Ciphera, który wtedy przyszedł do mnie i innych z fantastycznym pomysłem tego serwera!), a także World of Gothic (a przez to również podziękowania dla DonEstebana!) za wspaniałą pomoc przez te wszystkie lata. Bez wszystkich zaangażowanych nic z tego nie byłoby możliwe.',
      cr_thanks_4: 'Aktorom głosowym z oryginału, którzy częściowo zgodzili się na wykorzystanie AI lub nawet / alternatywnie wyrazili zgodę na ponowne nagranie kwestii. Cała społeczność pokochała waszą pracę i wciąż ją celebruje ponad 25 lat później. Bardzo, bardzo dziękujemy.',
    ...
    ru: {
      ...
      cr_thanks_1: 'Остальной части основной команды, которая, несмотря на разногласия и долгие обсуждения, долгое время не сдавалась – ведь без вас мод был бы сегодня лишь на четверть таким большим и хорошим.',
      cr_thanks_2: 'Всем из моддинг-сообщества Gothic, кто делился своими ресурсами и материалами, чтобы ими могли пользоваться.',
      cr_thanks_3: 'Сообществу <a href="https://discord.gg/P3kZcnfXzZ" target="_blank" rel="noopener noreferrer">Gothic Modding Community</a> (сервер Discord под управлением Cipher, который тогда пришёл ко мне и другим с фантастической идеей этого сервера!), а также World of Gothic (и тем самым – спасибо DonEsteban!) за потрясающую помощь на протяжении этих лет. Без всех участников ничего из этого не было бы возможно.',
      cr_thanks_4: 'Актёрам озвучки из оригинала, некоторые из которых согласились на использование ИИ или даже / в качестве альтернативы согласились записать свои реплики заново. Всё сообщество полюбило вашу работу и до сих пор чтит её спустя более чем 25 лет. Огромное, огромное спасибо.',
      screenshot: 'Скриншот',
