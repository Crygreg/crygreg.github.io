...
(function () {
  ...
  var translations = {
    de: {
      ...
      g2_e1: 'Neu geordnetes Statusmenü mit Seitenwechsel; LP-Verbrauch wird statt Charakterwerten festgehalten',
    ...
    en: {
      ...
      g2_e1: 'Reordered status menu with page switching; LP costs are recorded instead of character stats',
    ...
    pl: {
      ...
      g2_e1: 'Przegrupowane menu statusu z przerzucaniem stron; zużycie PN zapisywane zamiast statystyk postaci',
    ...
    ru: {
      ...
      g2_e1: 'Перекомпонованное меню статуса с перелистыванием страниц; расход ОО фиксируется вместо характеристик',
