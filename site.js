...
(function () {
  ...
  var translations = {
    de: {
      ...
      role_alistair: '2D/3D-Art & Animation · Daedalus-Scripting · Engine & GD3D11-Renderer (C++/Union) · Website · QA & Feedback',
      role_ben: '2D- & 3D-Artist · QA & Feedback',
      role_midgard: '3D-Artist · QA & Feedback',
      ...
      g2_m3_post: '<p>Die erste Release-Version von Lobarts Farm wird finalisiert. Dazu experimentieren wir mit neuer Vegetation – wie immer W.I.P.: Die Farben des Grases können sich noch leicht ändern.</p><p>Als Inspiration diente <a href="https://sun6-19.userapi.com/c851024/v851024127/1d58a8/9lS_SZUcqLY.jpg" target="_blank" rel="noopener noreferrer">dieses fantastische Artwork</a> – mir gefallen besonders das Licht und die Atmosphäre (Credits gehen an Martin Nawaz!).</p><p>Wie kürzlich angekündigt bin ich der Empfehlung gefolgt und habe einen <a href="https://patreon.com/Crygreg/" target="_blank" rel="noopener noreferrer">Patreon</a> eröffnet, auf dem ich ausführlichere Entwicklungs-Updates teile, Umfragen erstelle und Meinungen einhole – oder unterstützt uns über <a href="https://ko-fi.com/crygreg" target="_blank" rel="noopener noreferrer">Ko-Fi</a>!</p><p>Hinweis: Es gibt KEINE weiteren Vorteile dabei. Das Projekt soll nichtkommerziell bleiben – keine „exklusiven“ Pre-Release-Builds o. Ä. Patreon und Ko-Fi sind schlicht Wege, dieses und zukünftige Projekte zu unterstützen; fast alles Geld (und mein eigenes) fließt ohnehin in die Mod. Jede Unterstützung – finanziell oder nicht – wird sehr geschätzt!</p><p>Wir arbeiten weiter an der ersten spielbaren Version – hoffentlich noch dieses Jahr, wenn es klappt.</p>',
    ...
    pl: {
      ...
      role_alistair: 'Grafika 2D/3D i animacja · Skrypty Daedalus · Silnik i renderer GD3D11 (C++/Union) · Strona · QA i feedback',
      role_ben: 'Artysta 2D i 3D · QA i feedback',
      role_midgard: 'Artysta 3D · QA i feedback',
    ...
    ru: {
      ...
      role_alistair: '2D/3D и анимация · Скрипты Daedalus · Движок и рендер GD3D11 (C++/Union) · Сайт · QA и обратная связь',
      role_ben: '2D- и 3D-художник · QA и обратная связь',
      role_midgard: '3D-художник · QA и обратная связь',
