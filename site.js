...
(function () {
  ...
  var translations = {
    de: {
      ...
      cr_thanks_1: 'An den Rest des Kernteams, der trotz etwaiger Meinungsverschiedenheiten und langen Diskussionen über längere Zeit am Ball blieb, denn ohne sie wäre die Mod heute nur zu einem Viertel so groß und gut geworden.',
    ...
    en: {
      ...
      cr_thanks_1: 'To the rest of the core team, who stuck with it despite disagreements and long discussions over a long time – because without them, the mod would only be a quarter as big and as good today.',
    ...
    pl: {
      ...
      cr_thanks_1: 'Reszcie głównego zespołu, który mimo różnic zdań i długich dyskusji wytrwał przez długi czas – bo bez nich mod byłby dziś tylko w jednej czwartej tak duży i dobry.',
    ...
    ru: {
      ...
      cr_thanks_1: 'Остальной части основной команды, которая, несмотря на разногласия и долгие обсуждения, долгое время не сдавалась – ведь без них мод был бы сегодня лишь на четверть таким большим и хорошим.',
