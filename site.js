...
(function () {
  ...
  var translations = {
    de: {
      ...
      role_crygreg: 'Projektersteller, Teamleitung & Lead-Dev · Ideen & Design · Spacering · Writing & Quest Design · Voice Direction · 3D-Art & Animation · 2D-Art · Coding',
      role_alistair: 'Ideen & Design · 3D-Art & Animation · 2D-Art · Coding · QA & Testing',
      role_ben: 'Ideen & Design · 3D- & 2D-Art · QA & Testing',
      ...
      media_unavailable: '(derzeit nicht verfügbar)',
      ...
      credits_h: 'Credits',
      credits_core: 'Kernteam',
      credits_support: 'Zusätzlicher Support',
      credits_assets: 'Assets (aus der MDB und dergleichen)',
      credits_cat_models: '3D-Modelle / Weltobjekte',
      credits_cat_armor: 'Rüstungen & Kleidung',
      credits_cat_weapons: 'Waffen & Ausrüstung',
      credits_cat_creatures: 'Kreaturen & Charaktere',
      credits_cat_textures: 'Texturen & visuelle Assets',
      credits_cat_misc: 'Verschiedene Assets',
      credits_thanks: 'Besonderer Dank',
      cr_s_snowfox: 'Spacer-Support, Ideen & Feedback',
      cr_s_silas: 'Writing-Support, Ideen & Feedback',
      cr_s_risepolak: 'Animationen & Babe-Model, zusätzliche VFX',
      cr_s_3d: '3D-Support',
      cr_s_damiandel: '3D-Support (Gaan Pass, PsiCamp-Model)',
      cr_s_damian: 'zusätzliches Feedback & Kooperation',
      cr_s_2d3d: '2D- & 3D-Support',
      cr_s_loki: 'Körpermodell-Support',
      cr_thanks_1: '<a href="images/G2AE/TeamMedal.webp">Dem Kernteam</a>, das trotz etwaiger Meinungsverschiedenheiten und langen Diskussionen über längere Zeit am Ball blieb – denn ohne es wäre die Mod heute nur zu einem Viertel so groß und gut geworden.',
      cr_thanks_2: 'All jene aus der Gothic Modding Community, die ihre Assets und Ressourcen zur Verfügung gestellt haben.',
      cr_thanks_3: 'Die <a href="https://discord.gg/P3kZcnfXzZ" target="_blank" rel="noopener noreferrer">Gothic Modding Community</a> (Discord-Server, betrieben von Cipher, der damals mit der fantastischen Idee für diesen Server an uns herantrat!) &amp; auch World of Gothic (und damit auch ein Dank an DonEsteban!) für die grandiose Hilfe im Laufe der Jahre. Ohne alle Beteiligten wäre das hier nie möglich gewesen.',
      cr_thanks_4: 'Die Synchronsprecher aus dem Original, die teilweise einer KI-Nutzung zugestimmt haben oder sogar einwilligten, ihre Rollen neu einzusprechen. Die gesamte Community hat eure Arbeit geliebt und feiert sie auch heute noch, mehr als 25 Jahre später. Vielen, vielen Dank.',
      screenshot: 'Screenshot',
      download_h: 'Download',
      download_note: 'Die Anniversary Edition befindet sich noch in Entwicklung – der Download erscheint Ende 2026 / Anfang 2027.',
      download_btn: 'DOWNLOAD',
      download_soon: 'Der Download ist noch nicht verfügbar – Release Ende 2026 / Anfang 2027.',
      g1_download_note: 'Gothic I Anniversary Edition befindet sich noch in der Planungsphase – die Entwicklung beginnt nach dem Release von Gothic II AE.',
      g1_download_soon: 'Der Download ist noch nicht verfügbar.',
      secret_download_note: 'Dieses Projekt befindet sich noch in der Planungsphase – die Entwicklung beginnt nach Gothic I AE.',
      secret_download_soon: 'Der Download ist noch nicht verfügbar.',
    ...
    en: {
      ...
      role_crygreg: 'Project Creator, Team Lead & Lead Dev · Ideas & Design · Spacering · Writing & Quest Design · Voice Direction · 3D Art & Animation · 2D Art · Coding',
      role_alistair: 'Ideas & Design · 3D Art & Animation · 2D Art · Coding · QA & Testing',
      role_ben: 'Ideas & Design · 3D & 2D Art · QA & Testing',
      ...
      media_unavailable: '(currently unavailable)',
      ...
      credits_h: 'Credits',
      credits_core: 'Core team',
      credits_support: 'Additional support',
      credits_assets: 'Assets (from the MDB and the like)',
      credits_cat_models: '3D models / world objects',
      credits_cat_armor: 'Armor & clothing',
      credits_cat_weapons: 'Weapons & equipment',
      credits_cat_creatures: 'Creatures & characters',
      credits_cat_textures: 'Textures & visual assets',
      credits_cat_misc: 'Miscellaneous assets',
      credits_thanks: 'Special thanks',
      cr_s_snowfox: 'Spacer support, ideas & feedback',
      cr_s_silas: 'Writing support, ideas & feedback',
      cr_s_risepolak: 'Animations & babe model, additional VFX',
      cr_s_3d: '3D support',
      cr_s_damiandel: '3D support (Gaan Pass, PsiCamp model)',
      cr_s_damian: 'additional feedback & cooperation',
      cr_s_2d3d: '2D & 3D support',
      cr_s_loki: 'body model support',
      cr_thanks_1: 'To <a href="images/G2AE/TeamMedal.webp">the core team</a>, who stuck with it through disagreements and long discussions over the years – because without them, the mod would only be a quarter as big and as good today.',
      cr_thanks_2: 'Everyone in the Gothic modding community who shared their assets and resources for others to use.',
      cr_thanks_3: 'The <a href="https://discord.gg/P3kZcnfXzZ" target="_blank" rel="noopener noreferrer">Gothic Modding Community</a> (Discord server run by Cipher, who back then approached us with the fantastic idea for this server!) &amp; also World of Gothic (and with that, thanks to DonEsteban!) for the amazing help over the years. Without everyone involved, none of this would have been possible.',
      cr_thanks_4: 'The voice actors from the original, some of whom agreed to the use of AI or even consented to re-record their lines. The entire community loved your work and still celebrates it more than 25 years later. Thank you so, so much.',
      screenshot: 'Screenshot',
      download_h: 'Download',
      download_note: 'The Anniversary Edition is still in development – the download will release late 2026 / early 2027.',
      download_btn: 'DOWNLOAD',
      download_soon: 'The download is not available yet – releasing late 2026 / early 2027.',
      g1_download_note: 'Gothic I Anniversary Edition is still in the planning phase – development begins after the release of Gothic II AE.',
      g1_download_soon: 'The download is not available yet.',
      secret_download_note: 'This project is still in the planning phase – development begins after Gothic I AE.',
      secret_download_soon: 'The download is not available yet.',
    ...
    pl: {
      ...
      projects_intro: 'Aby dowiedzieć się więcej, kliknij wybrany projekt.',
      g1_desc: 'Witaj z powrotem w Kolonii!',
      g2_desc: 'Jeden człowiek odmienił losy wielu setek...',
      secret_desc: 'Tajny projekt jest w trakcie...',
      secret_question: 'Co my tu mamy?',
      more_info: 'DOWIEDZ SIĘ WIĘCEJ',
      eyebrow_about: 'O Edycji Rocznicowej (Anniversary Edition)',
      about_title: 'Co jest celem?',
      about_text: 'Edycja Rocznicowa to seria niekomercyjnych projektów fanowskich, które mają na celu rozszerzenie świata Gothic o nowe zadania, postacie, historie i pomysły – nie tracąc z oczu oryginalnego charakteru modyfikowanych gier.',
      eyebrow_team: 'NASZ',
      eyebrow_support: 'WESPRZYJ NAS',
      eyebrow_join: 'DOŁĄCZ',
      join_h: 'Poszukujemy artystów',
      join_text: 'Szukamy grafików 2D i 3D do Edycji Rocznicowej (Anniversary Edition) – tekstury, koncept arty lub modele. Zainteresowany/a? Odezwij się na naszym <a href="https://discord.gg/P5TWh8krmc" target="_blank" rel="noopener noreferrer">Discordzie</a>.',
      team_title: 'Zespół',
      team_intro: 'Kreatywne umysły stojące za projektami.',
      role_crygreg: 'Twórca projektu, lider zespołu i główny deweloper · Pomysły i design · Spacering · Pisanie i projektowanie questów · Kierownictwo głosowe · Grafika 3D i animacje · Grafika 2D · Kodowanie',
      role_alistair: 'Pomysły i design · Grafika 3D i animacje · Grafika 2D · Kodowanie · QA i testowanie',
      role_ben: 'Pomysły i design · Grafika 3D i 2D · QA i testowanie',
      role_midgard: 'Pomysły i koncepcje · Grafik 3D · QA i feedback',
      footer1: 'ANNIVERSARY EDITION',
      ...
      media_unavailable: '(obecnie niedostępne)',
      ...
      support_h: 'Wesprzyj',
      support_note: 'Poniżej znajdziecie prywatne strony Crygrega i Alistaira Aftona – dobrowolne sposoby na wsparcie rozwoju; projekt pozostaje niekomercyjny.',
      credits_h: 'Twórcy',
      credits_core: 'Główny zespół',
      credits_support: 'Dodatkowe wsparcie',
      credits_assets: 'Zasoby (z MDB i podobnych źródeł)',
      credits_cat_models: 'Modele 3D / obiekty świata',
      credits_cat_armor: 'Pancerze i ubrania',
      credits_cat_weapons: 'Broń i wyposażenie',
      credits_cat_creatures: 'Stworzenia i postacie',
      credits_cat_textures: 'Tekstury i zasoby wizualne',
      credits_cat_misc: 'Różne zasoby',
      credits_thanks: 'Specjalne podziękowania',
      cr_s_snowfox: 'Wsparcie Spacera, pomysły i opinie',
      cr_s_silas: 'Wsparcie pisarskie, pomysły i opinie',
      cr_s_risepolak: 'Animacje i model babe, dodatkowe VFX',
      cr_s_3d: 'Wsparcie 3D',
      cr_s_damiandel: 'Wsparcie 3D (Gaan Pass, model PsiCamp)',
      cr_s_damian: 'dodatkowe opinie i współpraca',
      cr_s_2d3d: 'Wsparcie 2D i 3D',
      cr_s_loki: 'Wsparcie modelu ciała',
      cr_thanks_1: '<a href="images/G2AE/TeamMedal.webp">Głównemu zespołowi</a>, który mimo różnic zdań i długich dyskusji wytrwał przez długi czas – bo bez niego mod byłby dziś tylko w jednej czwartej tak duży i dobry.',
      cr_thanks_2: 'Wszystkim ze społeczności modderskiej Gothic, którzy dzielili się swoimi zasobami i materiałami, aby inni mogli z nich korzystać.',
      cr_thanks_3: 'Społeczności <a href="https://discord.gg/P3kZcnfXzZ" target="_blank" rel="noopener noreferrer">Gothic Modding Community</a> (serwer Discord prowadzony przez Ciphera, który wtedy zwrócił się do nas z fantastycznym pomysłem tego serwera!), a także World of Gothic (a przez to również podziękowania dla DonEstebana!) za wspaniałą pomoc przez te wszystkie lata. Bez wszystkich zaangażowanych nic z tego nie byłoby możliwe.',
      cr_thanks_4: 'Aktorom głosowym z oryginału, którzy częściowo zgodzili się na wykorzystanie AI, a niektórzy nawet zgodzili się nagrać swoje kwestie na nowo. Cała społeczność pokochała waszą pracę i wciąż ją docenia ponad 25 lat później. Bardzo, bardzo dziękujemy.',
      screenshot: 'Zrzut ekranu',
      download_h: 'Pobieranie',
      download_note: 'Edycja Rocznicowa jest wciąż w fazie rozwoju – link do pobrania pojawi się pod koniec 2026 / na początku 2027 roku.',
      download_btn: 'POBIERZ',
      download_soon: 'Pobieranie nie jest jeszcze dostępne – premiera pod koniec 2026 / na początku 2027 roku.',
      g1_download_note: 'Gothic I Anniversary Edition jest wciąż w fazie planowania – prace rozpoczną się po premierze Gothic II AE.',
      g1_download_soon: 'Pobieranie nie jest jeszcze dostępne.',
      secret_download_note: 'Ten projekt jest wciąż w fazie planowania – prace rozpoczną się po Gothic I AE.',
      secret_download_soon: 'Pobieranie nie jest jeszcze dostępne.',
    ...
    ru: {
      ...
      role_crygreg: 'Создатель проекта, лидер команды и ведущий разработчик · Идеи и дизайн · Spacering · Написание и дизайн квестов · Режиссура озвучки · 3D-арт и анимация · 2D-арт · Код',
      role_alistair: 'Идеи и дизайн · 3D-арт и анимация · 2D-арт · Код · QA и тестирование',
      role_ben: 'Идеи и дизайн · 3D- и 2D-арт · QA и тестирование',
      ...
      media_unavailable: '(сейчас недоступно)',
      ...
      credits_core: 'Основная команда',
      credits_support: 'Дополнительная поддержка',
      credits_assets: 'Ресурсы (из MDB и т. п.)',
      credits_cat_models: '3D-модели / объекты мира',
      credits_cat_armor: 'Броня и одежда',
      credits_cat_weapons: 'Оружие и снаряжение',
      credits_cat_creatures: 'Существа и персонажи',
      credits_cat_textures: 'Текстуры и визуальные ресурсы',
      credits_cat_misc: 'Разные ресурсы',
      credits_thanks: 'Особая благодарность',
      cr_s_snowfox: 'Поддержка Spacer, идеи и отзывы',
      cr_s_silas: 'Помощь в написании, идеи и отзывы',
      cr_s_risepolak: 'Анимации и модель babe, дополнительные VFX',
      cr_s_3d: 'Поддержка 3D',
      cr_s_damiandel: 'Поддержка 3D (Gaan Pass, модель PsiCamp)',
      cr_s_damian: 'дополнительные отзывы и сотрудничество',
      cr_s_2d3d: 'Поддержка 2D и 3D',
      cr_s_loki: 'Поддержка модели тела',
      cr_thanks_1: '<a href="images/G2AE/TeamMedal.webp">Основной команде</a>, которая, несмотря на разногласия и долгие обсуждения, долгое время не сдавалась – ведь без неё мод был бы сегодня лишь на четверть таким большим и хорошим.',
      cr_thanks_2: 'Всем из моддинг-сообщества Gothic, кто делился своими ресурсами и материалами, чтобы другие могли ими пользоваться.',
      cr_thanks_3: 'Сообществу <a href="https://discord.gg/P3kZcnfXzZ" target="_blank" rel="noopener noreferrer">Gothic Modding Community</a> (сервер Discord под управлением Cipher, который тогда обратился к нам с фантастической идеей этого сервера!), а также World of Gothic (и тем самым – спасибо DonEsteban!) за потрясающую помощь на протяжении этих лет. Без всех участников ничего из этого не было бы возможно.',
      cr_thanks_4: 'Актёрам озвучки из оригинала, некоторые из которых согласились на использование ИИ, а некоторые даже согласились записать свои реплики заново. Всё сообщество полюбило вашу работу и до сих пор чтит её спустя более чем 25 лет. Огромное, огромное спасибо.',
      screenshot: 'Скриншот',
      download_h: 'Скачивание',
      download_note: 'Юбилейное издание всё ещё в разработке – ссылка на скачивание появится в конце 2026 / начале 2027 года.',
      download_btn: 'СКАЧАТЬ',
      download_soon: 'Скачивание пока недоступно – релиз в конце 2026 / начале 2027 года.',
      g1_download_note: 'Gothic I Anniversary Edition находится на стадии планирования – разработка начнётся после выхода Gothic II AE.',
      g1_download_soon: 'Скачивание пока недоступно.',
      secret_download_note: 'Этот проект находится на стадии планирования – разработка начнётся после Gothic I AE.',
      secret_download_soon: 'Скачивание пока недоступно.',
      ...
      g1_media_soon: 'Контент скоро появится – мы работаем над этим!',
      g2_overview: 'Anniversary Edition — масштабное фанатское расширение и оверол-мод для Gothic II: Ночь Ворона. Оно расширяет и частично перерабатывает основной сюжет, а также старые и новые побочные задания, добавляет новые гильдии и пути, увеличивает мир новыми областями и жителями — и придаёт игре собственный визуальный стиль, основанный на Gothic I, альфе Gothic I, Gothic Sequel, альфа-материалах Gothic II и даже частях Gothic 3. После релиза выйдут обновления, которые продолжат расширять историю и перерабатывать меши мира.',
