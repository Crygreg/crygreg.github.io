...
(function () {
  ...
  var translations = {
    de: {
      ...
      role_alistair: 'Ideen & Design · 3D: Modelling, UV-Mapping, Vertex-Gruppen, Animation, Export/Import · 2D: Texturen, Artworks · Coding: Daedalus-Skripte, Engine & GD3D11-Renderer (C++/Union), Website · QA & Testing',
      role_ben: 'Ideen & Design · 3D: Modelling, UV-Mapping, Vertex-Gruppen, Export/Import · 2D: Skizzen, Texturen, Artworks · QA & Testing',
    ...
    en: {
      ...
      role_alistair: 'Ideas & Design · 3D: Modeling, UV mapping, vertex groups, animation, export/import · 2D: Textures, artwork · Coding: Daedalus scripts, engine & GD3D11 renderer (C++/Union), website · QA & Testing',
      role_ben: 'Ideas & Design · 3D: Modeling, UV mapping, vertex groups, export/import · 2D: Sketches, textures, artwork · QA & Testing',
    ...
    pl: {
      ...
      role_alistair: 'Pomysły i design · 3D: Modelowanie, mapowanie UV, grupy wierzchołków, animacje, eksport/import · 2D: Tekstury, grafika · Kodowanie: skrypty Daedalus, silnik i renderer GD3D11 (C++/Union), strona · QA i testowanie',
      role_ben: 'Pomysły i design · 3D: Modelowanie, mapowanie UV, grupy wierzchołków, eksport/import · 2D: Szkice, tekstury, grafika · QA i testowanie',
    ...
    ru: {
      ...
      role_alistair: 'Идеи и дизайн · 3D: моделирование, UV-развёртка, группы вершин, анимации, экспорт/импорт · 2D: текстуры, арт · Код: скрипты Daedalus, движок и рендер GD3D11 (C++/Union), сайт · QA и тестирование',
      role_ben: 'Идеи и дизайн · 3D: моделирование, UV-развёртка, группы вершин, экспорт/импорт · 2D: скетчи, текстуры, арт · QA и тестирование',
